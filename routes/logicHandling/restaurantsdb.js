...
function getRestaurants(callback, res, parameters) {
  var queryString = 'select restaurants.name, image, city, state, rating, ' +
  'description, restaurants.id, cuisine_id, cuisines.name as cuisine_name ' +
  'from restaurants inner join cuisines on' +
